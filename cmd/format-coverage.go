...
import (
	...
	"github.com/codeclimate/test-reporter/formatters/swiftcov"
...
var formatterList = []string{"simplecov", "lcov", "coverage.py", "clover", "gocov", "swiftcov"}
